...
if (!has_targets) {
  message("This vignette requires the 'targets' package.")
  message("Install with: install.packages('targets')")
...
pipeline_exists <- has_targets && file.exists("_targets/meta/meta")
