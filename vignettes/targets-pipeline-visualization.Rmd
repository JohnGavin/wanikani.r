...
# Set pipeline_exists to FALSE by default (will be overridden if targets is available)
...
# If packages available, load them and check for pipeline
if (has_targets) {
  library(targets)
  library(dplyr)
  library(tidyr)
  ...
  # Now check if pipeline has been run
