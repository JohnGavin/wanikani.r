...
plot_build_times <- tar_read(plot_build_times)
...
time_stats <- tar_read(table_time_stats)
knitr::kable(
  time_stats,
...
plot_memory <- tar_read(plot_memory_usage)
print(plot_memory)
```
...
memory_stats <- tar_read(table_memory_stats)
knitr::kable(
  memory_stats,
...
manifest <- tar_read(table_manifest)
knitr::kable(
  manifest,
